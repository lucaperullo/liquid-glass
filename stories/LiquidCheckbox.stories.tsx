...
const meta: Meta<typeof LiquidCheckbox> = {
  title: 'Components/Input/LiquidCheckbox',
    ...
    return (
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="p-4 bg-white/50 rounded-lg">
          <p className="text-sm font-medium">Checkbox state: <span className="font-bold">{checked ? 'Checked' : 'Unchecked'}</span></p>
        </div>
      </div>
    );
  },
